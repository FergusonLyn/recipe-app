...
const Meal = () => {
    ...
    // const filterCat = useCallback((category) => {
    //     setFoods((prevFoods) =>
    //       prevFoods.filter((item) => item.category === category)
    //     );
    //   }, []);
    ...
    <div className='max-w-[1520px] m-auto px-4 py-12'>
      ...
      <div className='flex flex-col lg:flex-row justify-center'>
            <div className='flex justify-center md:justify-center'>
                ...
                <button className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'
                 onClick={() => filterCat("salad")}   >Salad</button>
                <button className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'
                onClick={() => filterCat("chicken")}   >Chicken</button>
                <button className='m-1 border-orange-700 text-white bg-orange-700 hover:bg-white hover:text-orange-700 hover:border-orange-700'
                onClick={() => filterCat("pizza")}   >Pizza</button>
            </div>
      </div>
